...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="stylemonty.css" />
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css"
    />
    <title>Responsive music player project</title>
  </head>
  ...
  <body>
    <header>
      ...
      <div class="song_side">
            ...
            <input type="text" placeholder="Search Music..." />
             <div class="search_results">
              <a href="" class="card">
                ...
                <div class="content">
                  O O Jane JAna
                  <div class="subtitle">Kamal Khan</div>
                </div>
              </a>
        ...
        <div class="content">
          ...
          <p>
            ...
            fade <br />
            Away afraid our aim is out of sight Wanna see Alive
          </p>
          <div class="buttons">
            <button>PLAY</button>
      ...
      <div class="master_play">
        ...
        <h5 id="title">
          Vande mataram
          <div class="subtitle">Bankim Chandraa</div>
        </h5>
        <div class="icon">
